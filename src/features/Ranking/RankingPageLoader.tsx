...
const UserSkeletonRanking = () => {
  return (
    <li className="flex h-20 flex-row items-center gap-2 p-4 border border-neutral-700 rounded-lg relative *:animate-pulse">
      <div className="bg-neutral-700 size-9 rounded-full aspect-square flex items-center justify-center"></div>
